...
const ClaudeLogo = () => (
  <Svg height={42} viewBox="0 0 256 257" width={42}>
    <Path
...
const GeminiLogo = () => (
  <Svg height={42} viewBox="0 0 296 298" width={42}>
    <Defs>
      <Filter
      ...
      >
        <Path
          d="m141.201 4.886c2.282-6.17 11.042-6.071 13.184.148l5.985 17.37a184.004 184.004 0 0 0 111.257 113.049l19.304 6.997c6.143 2.227 6.156 10.91.02 13.155l-19.35 7.082a184.001 184.001 0 0 0-109.495 109.385l-7.573 20.629c-2.241 6.105-10.869 6.121-13.133.025l-7.908-21.296a184 184 0 0 0-109.02-108.658l-19.698-7.239c-6.102-2.243-6.118-10.867-.025-13.132l20.083-7.467a183.998 183.998 0 0 0 108.459-108.654z"
          fill="#3186ff"
        />
      </Mask>
    </Defs>
    <G mask="url(#gemini-h)">
      <G filter="url(#gemini-a)">
      ...
      <G filter="url(#gemini-d)">
        <Path
          d="m194 10.5c-22 72-128.5 123.833-171.5 124.5l121.5-201z"
          fill="#fa4340"
        />
      </G>
      <G filter="url(#gemini-e)">
        <Path
          d="m190.5-12.5c-22 72-128.5 123.833-171.5 124.5l121.5-201z"
          fill="#fa4340"
        />
      </G>
      <G filter="url(#gemini-f)">
        <Path
          d="m194.5 279.5c-22-72-128.5-123.833-171.5-124.5l121.5 201z"
          fill="#14bb69"
        />
      </G>
      <G filter="url(#gemini-g)">
        <Path
          d="m196.5 320.5c-22-72-128.5-123.833-171.5-124.5l121.5 201z"
          fill="#14bb69"
        />
      </G>
    </G>
...
const OpenAiLogo = () => (
  <Svg height={42} viewBox="0 0 256 260" width={42}>
    <Path
...
const getClientLogo = (clientName: string) => {
  ...
  if (normalizedName.includes('claude')) return <ClaudeLogo />;
...
export const OAuthLogoPair = ({ clientName }: { clientName: string }) => {
