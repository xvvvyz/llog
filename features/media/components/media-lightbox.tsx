...
import { useMediaLightboxDismiss } from '@/features/media/hooks/use-media-lightbox-dismiss';
import { useMediaLightboxTransition } from '@/features/media/hooks/use-media-lightbox-transition';
